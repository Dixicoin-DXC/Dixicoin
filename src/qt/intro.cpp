...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DixiCoin Core"),
     ...
     * override -datadir in the dixicoin.conf file in the default data directory
     * (to be consistent with dixicoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
