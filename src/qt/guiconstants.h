...
/* DixiCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DixiCoin"
#define QAPP_ORG_DOMAIN "dixicoin.com"
#define QAPP_APP_NAME_DEFAULT "DixiCoin-Qt"
#define QAPP_APP_NAME_TESTNET "DixiCoin-Qt-testnet"
