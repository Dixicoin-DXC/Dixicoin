...
/** Utility functions used by the DixiCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render DixiCoin addresses in monospace font
...
// Parse "dixicoin:" URI into recipient object, return true on successful parsing
