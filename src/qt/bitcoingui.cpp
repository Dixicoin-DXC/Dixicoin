                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DixiCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DixiCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dixicoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DixiCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DixiCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DixiCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DixiCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DixiCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DixiCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DixiCoin Core help message to get a list with possible DixiCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DixiCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DixiCoin network", "", count));
}
...
{
    QString strTitle = tr("DixiCoin Core"); // default title
