...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
		...
		if (nSporkID == SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2) r = SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT;
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_13_ENABLE_SUPERBLOCKS) r = SPORK_13_ENABLE_SUPERBLOCKS_DEFAULT;
        if (nSporkID == SPORK_14_NEW_PROTOCOL_ENFORCEMENT) r = SPORK_14_NEW_PROTOCOL_ENFORCEMENT_DEFAULT;
		if (nSporkID == SPORK_15_TREASURY_PAYMENT_ENFORCEMENT) r = SPORK_15_TREASURY_PAYMENT_ENFORCEMENT_DEFAULT;
		if (nSporkID == SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2) r = SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT;
		if (nSporkID == SPORK_17_NEW_PROTOCOL_ENFORCEMENT_3) r = SPORK_17_NEW_PROTOCOL_ENFORCEMENT_3_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
	...
	if (strName == "SPORK_15_TREASURY_PAYMENT_ENFORCEMENT") return SPORK_15_TREASURY_PAYMENT_ENFORCEMENT;
	if (strName == "SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2") return SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2;
	if (strName == "SPORK_17_NEW_PROTOCOL_ENFORCEMENT_2") return SPORK_17_NEW_PROTOCOL_ENFORCEMENT_3;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
	...
	if (id == SPORK_15_TREASURY_PAYMENT_ENFORCEMENT) return "SPORK_15_TREASURY_PAYMENT_ENFORCEMENT";
	if (id == SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2) return "SPORK_16_NEW_PROTOCOL_ENFORCEMENT_2";
