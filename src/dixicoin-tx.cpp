...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DixiCoin Core dixicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dixicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dixicoin transaction") + "\n" +
                               "  dixicoin-tx [options] -create [commands]   " + _("Create hex-encoded dixicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dixicoin transaction
