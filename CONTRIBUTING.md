Contributing to DixiCoin Core
============================

The DixiCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DixiCoin Core project, and is not to be
confused with overall DixiCoin Network Protocol consensus changes.

Whether a pull request is merged into DixiCoin Core rests with the project merge
...
Patches that change DixiCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DixiCoin consensus, it must have been
...
The project leader is the release manager for each DixiCoin Core release.
