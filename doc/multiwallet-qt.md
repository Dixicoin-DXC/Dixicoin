...
In order to support loading of multiple wallets in dixicoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dixicoin.cpp.
...
Changes to dixicoin.cpp
----------------------
dixicoin.cpp is the entry point into dixicoin-qt, and as such, will require some minor modifications to provide hooks for
