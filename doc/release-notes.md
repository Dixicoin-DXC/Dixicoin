DixiCoin Core version 2.2.1 is now available from:

  <https://github.com/dixicoin-project/dixicoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/dixicoin-project/dixicoin/issues>

Compatibility
==============

DixiCoin Core is extensively tested on multiple operating systems using
...
DixiCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that DixiCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/dixicoin-project-translations/).
