...
This means one can have an always-on dixicoind instance running, and another local dixicoind/dixicoin-qt instance which connects to this node and receives blocks from it.
