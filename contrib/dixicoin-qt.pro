...
RESOURCES += src/qt/dixicoin.qrc src/qt/dixicoin_locale.qrc

TRANSLATIONS += src/qt/locale/dixicoin_bg.ts \
                src/qt/locale/dixicoin_de.ts \
                src/qt/locale/dixicoin_en.ts \
                src/qt/locale/dixicoin_es.ts \
                src/qt/locale/dixicoin_fi.ts \
                src/qt/locale/dixicoin_fr.ts \
                src/qt/locale/dixicoin_it.ts \
                src/qt/locale/dixicoin_ja.ts \
                src/qt/locale/dixicoin_pl.ts \
                src/qt/locale/dixicoin_pt.ts \
                src/qt/locale/dixicoin_ru.ts \
                src/qt/locale/dixicoin_sk.ts \
                src/qt/locale/dixicoin_sv.ts \
                src/qt/locale/dixicoin_vi.ts \
                src/qt/locale/dixicoin_zh_CN.ts \
                src/qt/locale/dixicoin_zh_TW.ts
